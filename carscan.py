...
if x==0:
    output=change_bg.change_bg_img(f_image_path = ORI,b_image_path = "C:/Users/Neel/PycharmProjects/VanGoghExperience/nobg.jpg" , detect="car",output_image_name="nobgview1.jpg")
